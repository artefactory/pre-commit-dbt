...
@pytest.mark.parametrize(("schema_yml", "expected_status_code", "source_path", "desired_path"), TESTS)
def test_check_source_folder_constraint(schema_yml, expected_status_code, source_path, desired_path, tmpdir):
