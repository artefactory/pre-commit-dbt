...
def check_source_path(paths: Sequence[str], source_folder_path: str) -> int:
    ...
    misplaced_sources = {source_path for source_path in source_paths if source_folder_path not in str(source_path)}
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    parser.add_argument(
        "--source-folder",
        required=True,
        help="Directory in which sources should be defined.",
    )
