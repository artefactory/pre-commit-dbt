...
def has_reference(paths: Sequence[str], manifest: Dict[str, Any]) -> int:
    ...
    for macro in macros :
        ...
        for key,value in nodes.items() :
            ...
            # maps original list elements which have the following format macro.[project_name].[macro_name] to macro_name
            macros_transformed_names = map(lambda x:x.split(".")[-1], macros_as_declared_in_manifest) 
